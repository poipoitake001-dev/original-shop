    ...
    try {
        ...
        await db.query(`
            CREATE TABLE IF NOT EXISTS site_settings (
                ...
                feature_2_title VARCHAR(100) DEFAULT NULL,
                feature_2_desc VARCHAR(200) DEFAULT NULL,
                feature_2_icon TEXT DEFAULT NULL,
                feature_3_title VARCHAR(100) DEFAULT NULL,
        ...
        const paymentColumns = [
            ...
            { name: 'feature_1_title', type: 'VARCHAR(100) DEFAULT NULL' },
            { name: 'feature_1_desc', type: 'VARCHAR(200) DEFAULT NULL' },
            { name: 'feature_1_icon', type: 'TEXT DEFAULT NULL' },
            { name: 'feature_2_title', type: 'VARCHAR(100) DEFAULT NULL' },
            { name: 'feature_2_desc', type: 'VARCHAR(200) DEFAULT NULL' },
            { name: 'feature_2_icon', type: 'TEXT DEFAULT NULL' },
